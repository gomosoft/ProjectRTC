...
function allowCors(req, res, next) {
  ...
  res.header('Access-Control-Allow-Headers', 'Accept, Authorization, Content-Type, X-Requested-With, Range, Pragma, Cache-Control, If-Modified-Since, withCredentials');
